export default function Compliance() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center text-zinc-400 py-24">
      ...
      <div className="text-xl font-semibold text-zinc-900 mb-2">Compliance Section</div>
      <div className="text-zinc-400 text-base mb-8">This is a placeholder for the Compliance section.</div>
    </div>
  );
} 