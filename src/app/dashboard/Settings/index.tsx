export default function Settings() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center bg-white dark:bg-[var(--background)] py-24">
      ...
      <div className="text-xl font-semibold mb-2 text-zinc-900 dark:text-[var(--foreground)]">Settings Section</div>
      <div className="text-zinc-400 dark:text-[var(--foreground)] text-base mb-8">This is a placeholder for the <span className="text-zinc-400 dark:text-[var(--foreground)]">Settings</span> section.</div>
    </div>
  );
} 