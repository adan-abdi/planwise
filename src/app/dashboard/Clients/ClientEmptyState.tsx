...
const ClientEmptyState: React.FC<ClientEmptyStateProps> = ({ onCreate }) => (
  <div className="flex-1 flex items-center justify-center">
    <div className="flex flex-col items-center justify-center text-center bg-white dark:bg-[var(--background)]">
      ...
      <div className="text-lg font-semibold text-zinc-900 dark:text-[var(--foreground)] mb-1">No clients on record</div>
      <div className="text-zinc-400 dark:text-[var(--foreground)] text-sm mb-6 px-4 text-center">Once you add clients a list of them will appear here in real time.</div>
